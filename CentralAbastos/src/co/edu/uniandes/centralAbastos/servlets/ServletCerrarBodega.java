...
public class ServletCerrarBodega extends ServletTemplate
{

	/**
	 * 
	 */
	private static final long serialVersionUID = -598023490764349205L;
	...
	public void escribirContenido(HttpServletRequest request, HttpServletResponse response) throws IOException 
	{
		...
		accion.add("resultadoCerrarBodega.htm");
		vista.put("accion", accion);
		try 
		{	
			ArrayList<ArrayList<String>> contenido = new ArrayList<ArrayList<String>>();
			ArrayList<String> codigos = instancia.darCodigosBodegasAbiertas();
