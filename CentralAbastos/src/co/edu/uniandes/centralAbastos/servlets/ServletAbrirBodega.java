...
public class ServletAbrirBodega extends ServletTemplate
{

	/**
	 * 
	 */
	private static final long serialVersionUID = -8834783049532138820L;
	...
	public void escribirContenido(HttpServletRequest request, HttpServletResponse response) throws IOException 
	{
		...
		accion.add("resultadoAbrirBodega.htm");
		vista.put("accion", accion);
		try 
		{	
			ArrayList<ArrayList<String>> contenido = new ArrayList<ArrayList<String>>();
			ArrayList<String> codigos = instancia.darCodigosBodegasCerradas();
